...
const styles = StyleSheet.create({
    ...
    mealTextActive: { fontWeight: '500' },
    timingBar: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 8, borderRadius: 8 },
    ...
    editTimingBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, marginLeft: 'auto', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
    ...
    timeInput: { borderWidth: 1, borderRadius: 8, paddingVertical: 8, paddingHorizontal: 12, fontSize: 14, width: 70, textAlign: 'center' },
