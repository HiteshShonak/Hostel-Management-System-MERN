...
const styles = StyleSheet.create({
    ...
    notLoggedInText: { fontSize: 14, marginTop: 4 },
    loginButton: { paddingVertical: 14, paddingHorizontal: 48, borderRadius: 12, marginTop: 24 },
    ...
    userName: { marginTop: 16, fontSize: 20, fontWeight: '600' },
    userRole: { fontSize: 14, fontWeight: '500', marginTop: 4 },
    card: {
    ...
    themeTitle: { fontSize: 14, fontWeight: '600' },
    themeToggleGroup: { flexDirection: 'row', gap: 8 },
    themeToggle: { width: 40, height: 40, borderRadius: 20, alignItems: 'center', justifyContent: 'center', borderWidth: 2 },
